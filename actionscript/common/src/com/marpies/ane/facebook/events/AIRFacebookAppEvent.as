...
package com.marpies.ane.facebook.events {
    ...
    /**
     * Defines constants for default Facebook app events.
     * Intended for use with <code>AIRFacebook.logEvent()</code>.
     */
    public class AIRFacebookAppEvent {
         ...
         * The <code>valueToSum</code> passed to <code>logEvent</code> should be the numeric rating.
         */
         ...
         * The <code>valueToSum</code> passed to <code>logEvent</code> should be the item's price.
         */
         ...
         * The <code>valueToSum</code> passed to <code>logEvent</code> should be the total price in the cart.
         */
         ...
         * The <code>valueToSum</code> passed to <code>logEvent</code> should be the number of credits spent.
         */
