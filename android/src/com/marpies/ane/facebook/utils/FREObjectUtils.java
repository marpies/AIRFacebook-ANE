...
public class FREObjectUtils {
	...
	public static Integer getIntFromFREObject( FREObject object ) {
		try {
	...
	public static Double getDoubleFromFREObject( FREObject object ) {
		try {
	...
	public static String[] getArrayOfStringFromFREArray( FREArray array ) {
		String[] result = null;
		...
		try {
			...
			for( int i = 0; i < length; i++ ) {
				try {
					result[i] = getStringFromFREObject( array.getObjectAt( (long) i ) );
				} catch( Exception e ) {
					e.printStackTrace();
				}
			}
	...
	public static Bundle getBundleFromFREArray( FREArray array ) {
		Bundle result = null;
		...
		try {
			...
			if( length > 0 ) {
				...
				for( long i = 0; i < length; ) {
					String key = getStringFromFREObject( array.getObjectAt( i++ ) );
					String value = getStringFromFREObject( array.getObjectAt( i++ ) );
	...
	public static JSONObject getJSONObjectFromFREArray( FREArray array ) {
